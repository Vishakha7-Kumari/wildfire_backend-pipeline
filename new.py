...
# Load ML model
model = joblib.load("wildfire_ensemble.pkl")
...
# Define our critical mountainous regions centrally so we can use them 
# for both the temperature filter AND forcing a denser heatmap grid.
CRITICAL_REGIONS = [
